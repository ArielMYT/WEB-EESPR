...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
            <a href="courses.php"><i class="fa fa-graduation-cap"></i>  Courses</a>
            <li>
            <a href="questions.php"><i class="fa fa-pencil-square"></i>  Questions</a>
            <li>
            <a href="categories.php"><i class="fa fa-th-list"></i>  Category</a>
            <li>
            <a href="#"><i class="fa fa-bell"></i>  Schedule</a>
            <li><!--schedule.php-->
            <a href="#"><i class="fa fa-area-chart"></i>  Results</a>
            <li><!--flot.php-->
            <a href="#"><i class="fa fa-check-square"></i>  Passers</a>
            <li><!--grid.php-->
            <a href="#"><i class="fa fa-plus"></i>  Add Students</a>
            <li><!--ae_student.php-->
            <a href="#"><i class="fa fa-users"></i>  Students List</a>
            <!--students.php-->
            <li>
